...
# - Оптимизирована логика обновления целевой позиции курсора
# Версия 0.034
# - Выделение детектора объектов в отдельный модуль
# - Рефакторинг кода для повышения модульности
# - Улучшенная организация кода с разделением на модули
# - Упрощение основного файла для лучшей поддержки
# Версия 0.033
